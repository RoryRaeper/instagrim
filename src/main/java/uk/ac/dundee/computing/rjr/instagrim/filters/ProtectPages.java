...
package uk.ac.dundee.computing.rjr.instagrim.filters;
 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/Upload/",
"/Upload/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
