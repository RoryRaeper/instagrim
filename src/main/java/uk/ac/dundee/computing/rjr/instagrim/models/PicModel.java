...
public class PicModel {
   ...
   public static BufferedImage createProcessed(BufferedImage img) {
    ...
    //method creates a new comment on the image and adds it to the database
    ...
    //method searches for comments on the specific image and recieves them from the database to display
